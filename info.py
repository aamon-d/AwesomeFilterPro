...
API_ID = int(environ.get('API_ID', '11277906'))
API_HASH = environ.get('API_HASH', '92355fd1fbfd7f32f7c6542907fedf10')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001616308548))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002195145166')).split()]
